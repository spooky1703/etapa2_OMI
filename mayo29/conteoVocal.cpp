/*Ejemplo: Pedir una cadena de caracteres (string) al usuario, e indicar cuantas
...
void pedirDatos(){
	...
	//pasar el nombre a mayuscula
	for (size_t i = 0; i < strlen(palabraUsuario); i++) {
		palabraUsuario[i] = toupper(palabraUsuario[i]);
	}
}
